describe VR::Reducer::Presidentielles::Annee2002 do
  ...
  before :each do
    stub_request(:get, "https://example.com/tour-1")
      .to_return(status: 200, body: file_fixture("presidentielles_2002/tour-1.csv"), headers: {})
    stub_request(:get, "https://example.com/tour-2")
      .to_return(status: 200, body: file_fixture("presidentielles_2002/tour-2.csv"), headers: {})
  end
